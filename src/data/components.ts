    ...
    subcategories: [
      {
        name: "regular button",
        intro:
          "The buttons are available in 3 variants (text, outlined and contained), 2 sizes (small and large) and 2 colors (primary and secondary). When no color prop is passed, the primary color is taken as a default value. Button appears as disabled when the boolean 'disabled' is passed to the component. Disabled button has no hover styling and is non-clickable.",
      },
      {
        name: "radio button",
        intro:
          "The radio buttons are available in 2 colors (primary and secondary). When no color prop is passed, the primary color is taken as a default value. Button appears as disabled when the boolean 'disabled' is passed to the component. Disabled radio button is non-clickable.",
      },
    ],
  },
  {
